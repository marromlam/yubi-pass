...
Allows one-click input of OTP codes from your Yubikey

## How it works

This extension adds a context menu on text areas that requests a otp code for
the current website to your Yubikey. The code returned is inserted in the text
area.
